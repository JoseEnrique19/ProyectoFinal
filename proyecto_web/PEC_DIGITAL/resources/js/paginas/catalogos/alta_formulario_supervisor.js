$(document).ready(function () {
    var paginaExito = "catalogos/lista_registros_supervisor.php";
    var controlador = "WEB-INF/Controllers/Catalogos/Controller_Formulario_Firmar.php";
    var form = "#formFormularioFirmar";
